...
--
-- Name: customers; Type: TABLE; Schema: public; Owner: ytosss
--
...
ALTER TABLE public.customers OWNER TO ytosss;

--
-- Name: departments; Type: TABLE; Schema: public; Owner: ytosss
--

CREATE TABLE public.departments (
    departments_id numeric(9,0) NOT NULL,
    departments_name character varying(35) NOT NULL,
    information character varying(50) NOT NULL
);


ALTER TABLE public.departments OWNER TO ytosss;

--
-- Name: feedbacks; Type: TABLE; Schema: public; Owner: ytosss
--
...
CREATE TABLE public.feedbacks (
    ...
    items_id numeric(9,0) NOT NULL,
    customer_id numeric(9,0) NOT NULL
);


ALTER TABLE public.feedbacks OWNER TO ytosss;

--
-- Name: items; Type: TABLE; Schema: public; Owner: ytosss
--

CREATE TABLE public.items (
    items_id numeric(9,0) NOT NULL,
    items_name character varying(200) NOT NULL,
...
ALTER TABLE public.items OWNER TO ytosss;

--
-- Name: orderdetails; Type: TABLE; Schema: public; Owner: ytosss
--
...
ALTER TABLE public.orderdetails OWNER TO ytosss;

--
-- Name: orderitems; Type: TABLE; Schema: public; Owner: ytosss
--
...
ALTER TABLE public.orderitems OWNER TO ytosss;

--
-- Name: orders; Type: TABLE; Schema: public; Owner: ytosss
--
...
ALTER TABLE public.orders OWNER TO ytosss;

--
-- Name: sell; Type: TABLE; Schema: public; Owner: ytosss
--

CREATE TABLE public.sell (
    items_id numeric(9,0) NOT NULL,
    suppliers_id numeric(10,0) NOT NULL
);


ALTER TABLE public.sell OWNER TO ytosss;

--
-- Name: suppliers; Type: TABLE; Schema: public; Owner: ytosss
--

CREATE TABLE public.suppliers (
    suppliers_id numeric(10,0) NOT NULL,
    suppliers_name character varying(100) NOT NULL,
    phone character varying(20) NOT NULL,
    address character varying(200) NOT NULL
);


ALTER TABLE public.suppliers OWNER TO ytosss;

--
-- Data for Name: customers; Type: TABLE DATA; Schema: public; Owner: ytosss
--
...
Sarah Chapman	holly17@yahoo.com	001-661-790-6521x370	8707 Lane Burgs, Orrhaven, MT 10874	133
...
Carl Wright	lauramoses@hotmail.com	389-496-6528x00536	712 Rachel Grove, North Patrickchester, NE 72589	375
...
--
-- Data for Name: departments; Type: TABLE DATA; Schema: public; Owner: ytosss
--

COPY public.departments (departments_id, departments_name, information) FROM stdin;
...
34	Challenge Department	Contain leg themselves away space.
...
319	Too Department	Kind quite response major together knowledge.
...
327	Dog Department	Series without leg.
...
--
-- Data for Name: feedbacks; Type: TABLE DATA; Schema: public; Owner: ytosss
--

COPY public.feedbacks (rating, feedbacks_id, feedbacks_date, comment_text, items_id, customer_id) FROM stdin;
...
2.2	191	2023-06-12	Hold however for everybody leader them skill performance.	112	37
...
2.0	216	2023-08-14	Single avoid rich toward popular lead with enough.	40	204
...
2.3	227	2023-08-08	Blood particularly could us hotel lead sit response blue increase unit study open.	81	92
...
2.2	259	2023-05-03	Mission training range step painting concern top outside there mother.	174	107
...
2.2	286	2023-06-29	Film include choose action model serve carry expert movement reach man sense federal.	6	314
...
1.7	289	2023-08-05	Book lay laugh red man fly charge wide against win example.	135	35
...
1.1	323	2023-05-11	Bag sister care suffer light power contain hold listen clearly difficult impact.	375	14
...
--
-- Data for Name: items; Type: TABLE DATA; Schema: public; Owner: ytosss
--

COPY public.items (items_id, items_name, status, price, stock, available_date, departments_id) FROM stdin;
...
30	Everything Item	out_of_stock	368.08	9	2025-01-06	226
...
197	Institution Item	out_of_stock	718.45	1	2025-03-21	319
...
356	Available Item	out_of_stock	188.16	6	2024-09-17	312
...
--
-- Data for Name: orderdetails; Type: TABLE DATA; Schema: public; Owner: ytosss
--
...
--
-- Data for Name: orderitems; Type: TABLE DATA; Schema: public; Owner: ytosss
--

COPY public.orderitems (quantity, order_id, items_id) FROM stdin;
5	66	384
7	190	368
7	178	223
4	147	115
...
--
-- Data for Name: orders; Type: TABLE DATA; Schema: public; Owner: ytosss
--

COPY public.orders (orders_date, orders_id, customer_id) FROM stdin;
2024-07-04	1	10
2025-01-23	2	196
2025-01-15	3	192
2024-09-16	4	338
...
--
-- Data for Name: sell; Type: TABLE DATA; Schema: public; Owner: ytosss
--

COPY public.sell (items_id, suppliers_id) FROM stdin;
148	169
103	283
76	299
109	212
...
--
-- Data for Name: suppliers; Type: TABLE DATA; Schema: public; Owner: ytosss
--

COPY public.suppliers (suppliers_id, suppliers_name, phone, address) FROM stdin;
...
131	Feedmix	585-489-4717	4945 Chinook Way
...
267	Janyx	435-656-2499	7985 Shoshone Circle
268	Babbleblab	856-735-4120	7350 Harper Crossing
269	Voonyx	738-252-4438	874 David Pass
...
285	Skibox	505-962-8548	46101 Hazelcrest Circle
...
329	Realmix	265-235-5124	2 Westerfield Hill
...
--
-- Name: customers customers_pkey; Type: CONSTRAINT; Schema: public; Owner: ytosss
--
...
--
-- Name: departments departments_pkey; Type: CONSTRAINT; Schema: public; Owner: ytosss
--
...
--
-- Name: feedbacks feedbacks_pkey; Type: CONSTRAINT; Schema: public; Owner: ytosss
--

ALTER TABLE ONLY public.feedbacks
    ADD CONSTRAINT feedbacks_pkey PRIMARY KEY (feedbacks_id);


--
-- Name: items items_pkey; Type: CONSTRAINT; Schema: public; Owner: ytosss
--
...
--
-- Name: orderdetails orderdetails_pkey; Type: CONSTRAINT; Schema: public; Owner: ytosss
--
...
--
-- Name: orderitems orderitems_pkey; Type: CONSTRAINT; Schema: public; Owner: ytosss
--

ALTER TABLE ONLY public.orderitems
    ADD CONSTRAINT orderitems_pkey PRIMARY KEY (order_id, items_id);


--
-- Name: orders orders_pkey; Type: CONSTRAINT; Schema: public; Owner: ytosss
--
...
--
-- Name: sell sell_pkey; Type: CONSTRAINT; Schema: public; Owner: ytosss
--

ALTER TABLE ONLY public.sell
    ADD CONSTRAINT sell_pkey PRIMARY KEY (items_id, suppliers_id);


--
-- Name: suppliers suppliers_pkey; Type: CONSTRAINT; Schema: public; Owner: ytosss
--
...
--
-- Name: feedbacks feedbacks_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ytosss
--
...
--
-- Name: feedbacks feedbacks_items_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ytosss
--

ALTER TABLE ONLY public.feedbacks
    ADD CONSTRAINT feedbacks_items_id_fkey FOREIGN KEY (items_id) REFERENCES public.items(items_id);


--
-- Name: items items_departments_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ytosss
--

ALTER TABLE ONLY public.items
    ADD CONSTRAINT items_departments_id_fkey FOREIGN KEY (departments_id) REFERENCES public.departments(departments_id);


--
-- Name: orderdetails orderdetails_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ytosss
--

ALTER TABLE ONLY public.orderdetails
    ADD CONSTRAINT orderdetails_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(orders_id);


--
-- Name: orderitems orderitems_items_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ytosss
--

ALTER TABLE ONLY public.orderitems
    ADD CONSTRAINT orderitems_items_id_fkey FOREIGN KEY (items_id) REFERENCES public.items(items_id);


--
-- Name: orderitems orderitems_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ytosss
--

ALTER TABLE ONLY public.orderitems
    ADD CONSTRAINT orderitems_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(orders_id);


--
-- Name: orders orders_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ytosss
--
...
--
-- Name: sell sell_items_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ytosss
--

ALTER TABLE ONLY public.sell
    ADD CONSTRAINT sell_items_id_fkey FOREIGN KEY (items_id) REFERENCES public.items(items_id);


--
-- Name: sell sell_suppliers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ytosss
--

ALTER TABLE ONLY public.sell
    ADD CONSTRAINT sell_suppliers_id_fkey FOREIGN KEY (suppliers_id) REFERENCES public.suppliers(suppliers_id);
